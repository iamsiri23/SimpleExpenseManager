            ...
            if (rawQuery.moveToFirst()) {
                do {
                    ...
                    String test=rawQuery.getString(rawQuery
                            .getColumnIndex(KEY_ACCOUNT_NUMBER));
            ...
            if (rawQuery.moveToFirst()) {
                do {
                    Account acc=new Account(
                            ...
                            rawQuery.getString(rawQuery.getColumnIndex(KEY_BANK_NAME)),
                            rawQuery.getString(rawQuery.getColumnIndex(KEY_HOLDER_NAME)),
                            rawQuery.getDouble(rawQuery.getColumnIndex(KEY_BALANCE)));
